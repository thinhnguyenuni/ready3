...
<div class="row w-100 d-flex justify-content-center">
	<div class="col-sm-12 col-md-6 bg-custom p-3 rounded">
		<div class="col-12 text-uppercase h2 text-center text-success ">
			Cập nhật hợp đồng bảo hiểm</div>
		<div class="p-4">
			<form:form action="${pageContext.request.contextPath}/hopdongbaohiem/update"
				method="post" modelAttribute="hopdongbaohiem" id="inputForm_update">
				<div class="form-group row">
					...
					<div class="col">
						<form:input path="maHopDong" type="text" class="form-control"
							id="input-mahopdong" placeholder="Mã hợp đồng (HD001)" autocomplete="off" />
