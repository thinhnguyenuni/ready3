...
<!--                   </li> -->
                   ...
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/hopdongbaohiem/create">Tạo mới hợp đồng bảo hiểm</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/hopdongbaohiem/update">Cập nhật hợp đồng bảo hiểm</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/giaodich/list">Thông tin hợp đồng</a></li>
              </ul>
          </div>
      </div>
  </nav>
