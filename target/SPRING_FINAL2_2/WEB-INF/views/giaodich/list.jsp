    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <h2 class="col-12 text-center text-success text-uppercase mb-3">Thông tin hợp đồng</h2>
                    <div class="col-12 d-flex justify-content-center">
                    	<a href="${pageContext.request.contextPath}/hopdongbaohiem/create" class="btn btn-success">Tạo mới hợp đồng</a>
                    </div>
                    <div class="col-12">
                            ...
                            <input type="hidden" name="pageSize" value="${pageSize}">
 							...
 							<div class="search input-group">
 							  ...
 							  <!-- Dòng 8: Input nhập thông tin tìm kiếm -->
       							<input type="text" name = "search" class="form-control search-input border-success" placeholder="Nhập mã hợp đồng" autocomplete="off" value="${search}">
       							<!-- Dòng 9: Nút tìm kiếm -->
                             ...
                             <!-- Dòng 13-36: Vòng lặp để hiển thị thông tin giao dịch -->
                                <c:forEach var="sumInfo" items="${sumInfos}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="update?id=${sumInfo.maKH}" class="btn btn-success">Update giao dịch</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
